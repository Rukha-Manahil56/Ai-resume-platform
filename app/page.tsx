...
import {
  ...
  Upload, Briefcase, ClipboardList, MessageSquare, X,
  Target, TrendingUp, Lightbulb, History,
} from "lucide-react";

/* ─────────────────────────────────────────────
   Auth hook — checks Supabase session once on mount
───────────────────────────────────────────── */
function useAuth() {
  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "28px 28px 0" }}>
        <p style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#aaa", marginBottom: "6px" }}>
          Platform
        </p>
        <h2 style={{ fontSize: "1.4rem", fontWeight: 750, color: "#0a0a0a", letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: "4px" }}>
          Everything you need to land the role
        </h2>
        <p style={{ fontSize: "13.5px", color: "#888", lineHeight: 1.6, marginBottom: "24px" }}>
          Six integrated tools that take you from application to offer.
        </p>
      </div>
      <div style={{ padding: "0 20px 28px", display: "flex", flexDirection: "column", gap: "8px" }}>
        {FEATURE_ITEMS.map(({ icon: Icon, title, desc }) => (
          ...
          >
            ...
            <div>
              <p style={{ fontSize: "13.5px", fontWeight: 650, color: "#0a0a0a", marginBottom: "3px", letterSpacing: "-0.01em" }}>
                {title}
              </p>
  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "28px 28px 0" }}>
        ...
        <h2 style={{ fontSize: "1.4rem", fontWeight: 750, color: "#0a0a0a", letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: "4px" }}>
          From upload to offer, in six steps
        </h2>
        <p style={{ fontSize: "13.5px", color: "#888", lineHeight: 1.6, marginBottom: "24px" }}>
          The entire process takes under two minutes to start.
        </p>
      </div>
        ...
        {HOW_STEPS.map((step, i) => (
          <div key={step.n} style={{ display: "flex", gap: "16px", position: "relative" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", flexShrink: 0 }}>
              <div style={{
                width: "30px", height: "30px",
                background: step.n === 1 ? "#0a0a0a" : "#f5f5f5",
                border: `1px solid ${step.n === 1 ? "#0a0a0a" : "#e8e8e8"}`,
                borderRadius: "50%",
                display: "flex", alignItems: "center", justifyContent: "center",
                flexShrink: 0,
              }}>
                <span style={{ fontSize: "11px", fontWeight: 700, color: step.n === 1 ? "#fff" : "#aaa" }}>
                  {step.n}
                </span>
              </div>
              {i < HOW_STEPS.length - 1 && (
                <div style={{ width: "1px", flex: 1, background: "#eee", minHeight: "24px", margin: "4px 0" }} />
              )}
            </div>
            {/* Right — content */}
            <div style={{ paddingBottom: i < HOW_STEPS.length - 1 ? "16px" : "0", paddingTop: "4px" }}>
              <p style={{ fontSize: "13.5px", fontWeight: 650, color: "#0a0a0a", marginBottom: "4px", letterSpacing: "-0.01em" }}>
                {step.title}
              </p>
  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "28px 28px 0" }}>
        ...
        <p style={{ fontSize: "13.5px", color: "#888", lineHeight: 1.6, marginBottom: "20px" }}>
          Practice with a role-specific AI interviewer that gives real-time feedback on every answer.
        </p>
      </div>

      <div style={{ padding: "0 20px", marginBottom: "20px" }}>
        {/* Interview stages */}
        <p style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "#bbb", marginBottom: "10px" }}>
          5 interview stages
        </p>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "20px" }}>
          {stages.map((s, i) => (
            <span key={s} style={{
              ...
              color: i === 0 ? "#fff" : "#555",
              border: `1px solid ${i === 0 ? "#0a0a0a" : "#eee"}`,
            }}>
              {s}
            </span>
          ))}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "4px" }}>
          {[
            ...
            "Voice input supported — speak your answers",
            "Best used after analyzing your resume first",
          ].map((point) => (
      ...
      <div style={{ padding: "16px 20px 24px", borderTop: "1px solid #f0f0f0" }}>
        <button
          onClick={() => { onClose(); navTo("/mock-interview"); }}
          style={{
  ...
  return (
    <Modal onClose={onClose}>
      <div style={{ padding: "28px 28px 0" }}>
        ...
        <p style={{ fontSize: "13.5px", color: "#888", lineHeight: 1.6, marginBottom: "20px" }}>
          Every resume analysis is saved so you can track your improvement over time.
        </p>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "20px" }}>
          {[
            ...
            <div key={label} style={{
              ...
              <p style={{ fontSize: "12.5px", fontWeight: 650, color: "#0a0a0a", marginBottom: "4px", letterSpacing: "-0.01em" }}>
                {label}
              </p>
      ...
      <div style={{ padding: "16px 20px 24px", borderTop: "1px solid #f0f0f0" }}>
        ...
        <p style={{ fontSize: "11.5px", color: "#bbb", textAlign: "center", marginTop: "8px" }}>
          Sign in required to view your saved reports
        </p>
      </div>
    </Modal>
  );
    ...
    <div className="min-h-screen bg-white text-black" style={{ fontFamily: "var(--font-geist-sans), system-ui, sans-serif" }}>
        ...
        <div className="hidden md:flex items-center gap-8">
          {(
            ...
            <button
              ...
              style={{
                fontSize: "13.5px", color: "#555", fontWeight: 450,
      ...
      >
        <div className="flex-1 max-w-xl">
          ...
          <h1 style={{ fontSize: "clamp(2.4rem, 5vw, 3.6rem)", fontWeight: 800, lineHeight: 1.06, letterSpacing: "-0.04em", color: "#0a0a0a", marginBottom: "24px" }}>
            ...
            <br />
            that gets you{" "}
            <span style={{ display: "inline-block", borderBottom: "3px solid #0a0a0a", paddingBottom: "1px" }}>
              interviewed.
            </span>
          </h1>
          ...
          {/* Hero CTAs — auth-gated */}
          <div className="flex flex-col sm:flex-row items-start gap-3 mb-10">
            <button
              onClick={() => navTo("/resume-analyzer")}
            ...
            <button
              ...
              style={{
                ...
                padding: "11px 22px", borderRadius: "10px",
                border: "1px solid #d8d8d8", letterSpacing: "-0.01em",
                transition: "border-color 0.15s", cursor: "pointer", fontFamily: "inherit",
              }}
      ...
      <section className="px-6 sm:px-10" style={{ paddingTop: "88px", paddingBottom: "88px", background: "#fafafa" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div className="mb-14">
            <p style={{ fontSize: "11.5px", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#888", marginBottom: "12px" }}>
              How it works
            </p>
          ...
          <div className="grid gap-px sm:grid-cols-2 lg:grid-cols-5" style={{ background: "#e8e8e8", borderRadius: "14px", overflow: "hidden" }}>
            {STEPS.map((step, i) => (
              <div key={step.title} style={{ background: "#fafafa", padding: "28px 24px", position: "relative" }}>
                <div style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "0.06em", color: "#bbb", marginBottom: "20px", fontVariantNumeric: "tabular-nums" }}>
                  0{i + 1}
                </div>
                <div style={{
                ...
                <p style={{ fontSize: "13.5px", fontWeight: 600, color: "#0a0a0a", letterSpacing: "-0.015em", marginBottom: "6px" }}>
                  {step.title}
                </p>
      ...
      <section className="px-6 sm:px-10" style={{ paddingTop: "88px", paddingBottom: "88px", background: "#fff" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((f, i) => (
              <FeatureCard key={f.title} {...f} large={i === 0} navTo={navTo} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="px-6 sm:px-10" style={{ paddingTop: "96px", paddingBottom: "96px", background: "#0a0a0a" }}>
        <div style={{ maxWidth: "640px", margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontSize: "11.5px", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#555", marginBottom: "20px" }}>
            Get started today
          </p>
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: "14px", padding: large ? "32px 28px" : "24px",
