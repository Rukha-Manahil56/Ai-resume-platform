  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 pt-36 pb-24 overflow-hidden">
        ...
        {/* Badge */}
        <div className="relative mb-6 inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-medium"
        ...
        {/* Headline */}
        <h1 className="relative mb-6 max-w-4xl"
            style={{ fontSize: "clamp(2.8rem,7vw,5rem)", fontWeight: 900, lineHeight: 1.05, letterSpacing: "-0.04em", color: "#0a0a0a" }}>
          Get Hired{" "}
          <span style={{
        ...
        {/* Subtitle */}
        <p className="relative mb-10 max-w-xl"
        ...
        <div className="relative flex flex-col sm:flex-row items-center gap-3 mb-16">
          <Link href="/login"
            ...
            style={{ background: "#8B5CF6", color: "white", boxShadow: "0 4px 24px rgba(139,92,246,0.35)" }}>
            Get Started Free
      ...
      <section className="px-6 py-24 sm:px-10" style={{ background: "#fafafa" }}>
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-14">
            <h2 style={{ fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 800, color: "#0a0a0a", letterSpacing: "-0.03em" }}>
              Everything you need to land the job
            </h2>
            <p className="mt-3 mx-auto max-w-lg" style={{ color: "#666", fontSize: "1.05rem", lineHeight: 1.7 }}>
              Our AI analyzes your resume against the job description and prepares you for every stage of the hiring process.
            </p>
          </div>
      ...
      <section className="px-6 py-24 sm:px-10 bg-white">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-14">
            <h2 style={{ fontSize: "clamp(1.8rem,4vw,2.6rem)", fontWeight: 800, color: "#0a0a0a", letterSpacing: "-0.03em" }}>
              How it works
            </h2>
          </div>
            ...
            {HOW_IT_WORKS.map((step, i) => (
              <div key={step.title} className="flex flex-col items-center text-center gap-4">
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-white font-bold text-lg"
                     style={{ background: i === 1 ? "#8B5CF6" : "#0a0a0a" }}>
                  {i + 1}
                </div>
                <h3 style={{ fontWeight: 700, fontSize: "1.1rem", color: "#0a0a0a" }}>{step.title}</h3>
      ...
      <section className="px-6 py-24 sm:px-10 text-center"
        ...
        <Link href="/login"
          ...
          style={{ background: "#8B5CF6", color: "white", boxShadow: "0 4px 24px rgba(139,92,246,0.4)" }}>
          Start for Free
      ...
      {/* ── Footer ── */}
      <footer className="px-6 py-6 text-center" style={{ background: "#0a0a0a", borderTop: "1px solid #1a1a1a" }}>
...
function FeatureCard({ icon: Icon, title, desc, accent }: {
  ...
  return (
    <div className="feature-card rounded-2xl p-6 bg-white"
...
const FEATURES = [
  {
    ...
    desc: "Get an instant ATS match score and see exactly how your CV ranks against the job description.",
    accent: "#8B5CF6",
  },
  {
    icon: Brain,
    title: "Skill Gap Analysis",
    desc: "Discover which skills you're missing and get prioritized recommendations to close the gap.",
    accent: "#0a0a0a",
  },
  {
    icon: Mic,
    title: "Mock Interview",
    desc: "Practice with an AI interviewer that asks role-specific questions and gives instant feedback.",
    accent: "#8B5CF6",
  },
  {
    icon: BarChart3,
    title: "Readiness Report",
    desc: "Get a full hiring readiness report with your strengths, gaps, and a clear action plan.",
    accent: "#0a0a0a",
  },
];
...
const HOW_IT_WORKS = [
  {
    ...
    desc: "Drop your PDF resume and paste the job description you're targeting.",
  },
  {
    title: "AI analyzes everything",
    desc: "Our AI scores your CV, finds skill gaps, and generates tailored interview questions.",
  },
  {
    title: "Get hired faster",
    desc: "Follow your personalized action plan and practice until you're fully ready.",
  },
];